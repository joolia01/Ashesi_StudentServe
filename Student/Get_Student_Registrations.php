...
function getRegisteredStudents()
{
   ...
   $sql = "SELECT registrationID, studentID, firstName, lastName, gender, dob,phoneNumber, interest, skills, previousExperiences, gpa, email, registerDate, oppID, approvalStatus FROM registration";
