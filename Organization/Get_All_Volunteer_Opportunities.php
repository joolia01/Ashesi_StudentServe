...
function getVolunteerOpportunities()
{
   ...
   $sql = "SELECT organizationName, cause, studentRole, volunteerDescription, volunteerLocation, startDate, endDate, numberOfHoursDaily, requirements FROM volunteerOpportunity";
